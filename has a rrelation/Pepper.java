class Pepper {
    ...
    Pepper(String name,String color,String type,String origin,double weight,double price,
           String taste,String quality,boolean organic,boolean spicy,int quantity,
